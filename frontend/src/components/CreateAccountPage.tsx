            ...
            <div className="flex min-h-screen items-center justify-center bg-gray-100">
                <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8">
                    ...
                    <form className="space-y-5">
                        <div>
                            <label className="block text-sm text-purple-700 font-medium mb-1" htmlFor="username">
                                Username
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm text-purple-700 font-medium mb-1" htmlFor="confirm-password">
                                Confirm Password
                            </label>
                            <input
                                type="password"
