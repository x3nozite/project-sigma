...
const react_konva_2 = require("react-konva");
...
const Html = ({ children, groupProps, divProps, transform, transformFunc, parentNodeFunc, }) => {
    const Bridge = (0, react_konva_2.useContextBridge)();
